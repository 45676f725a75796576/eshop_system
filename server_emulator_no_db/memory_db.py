...
db = {
    ...
    "warehouse": [{"warehouse_name":'Main Warehouse', "location_code":'WH-PRG-01', "is_active":1},{"warehouse_name":'Secondary Warehouse', "location_code":'WH-BRN-01', "is_active":0}],
    "products": [{"product_name":'Laptop', "unit_price":25000.00, "tax_rate":0.21}],
    "orders": [],
    "order_items": [],
    "inventory": [],
    "payments": [],
